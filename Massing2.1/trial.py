...
def constraint1(x):
    x1,x2,x3,y1,y2,y3=x
    return -1*(x1+100-x2)*(x2+50-x1)

def constraint2(x):
    x1,x2,x3,y1,y2,y3=x
    return -1*(y1+80-y2)*(y2+40-y1)

# rec1 and rec3 do not overlap
def constraint3(x):
    x1,x2,x3,y1,y2,y3=x
    return -1*(x1+100-x3)*(x3+30-x1)

def constraint4(x):
    x1,x2,x3,y1,y2,y3=x
    return -1*(y1+80-y3)*(y3+20-y1)

# rec2 and rec3 do not overlap
def constraint5(x):
    x1,x2,x3,y1,y2,y3=x
    return -1*(x3+30-x2)*(x2+50-x3) 

def constraint6(x):
    x1,x2,x3,y1,y2,y3=x
    return -1*(y3+20-y2)*(y2+40-y3)
