...
def supportPoly(polygon, direction):
    ...
    # for i in xrange(1, len(polygon)): # Correcting xrange formatting from Python 2
...
def collide(shape1, shape2, support1, support2):
    ...
    # for i in xrange(100): # Correcting xrange formatting from Python 2
    for i in range(100):
    ...
    #raise RuntimeError, "Infinite loop in GJK algorithm" # Correcting raise formatting from Python 2
